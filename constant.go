...
var pathAPIVoucherRedeemByBulk = newPath(methodPOST, "/vouchers/redeem")
...
var pathGetMemberKey = newPath(methodGET, "/loyalty/me/key?countryCode={country_code}&phoneNumber={phone_number}")
